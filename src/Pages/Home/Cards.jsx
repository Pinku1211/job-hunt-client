    ...
    return (
        <div className='bg-base-100'>
            <div className='max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-20'>
                ...
                <p className='text-[#5b0888] font-bold text-center mb-12'>With millions of up-to-date listings that connect you directly to company career sites, we make it easier to Getwork.</p>
                <div className='grid grid-cols-1 lg:grid-cols-3 gap-4'>
                    <div className="card shadow-lg text-neutral-content ">

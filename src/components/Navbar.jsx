            ...
            <nav className="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between" aria-label="Global">
                ...
                <div id="navbar-image-and-text-1" className="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:block">
                    <div className="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:pl-5">
                        <NavLink className={location.pathname === '/' ? 'text-blue-500' : 'text-black'} to="/">Home</NavLink>
                        <NavLink className={location.pathname === '/allJobs' && 'text-blue-500'} to="/allJobs">All Jobs</NavLink>
                        <NavLink className={location.pathname === '/appliedJobs' && 'text-blue-500'} to="/appliedJobs">Applied Jobs</NavLink>
                        <NavLink className={location.pathname === '/addJob' && 'text-blue-500'} to="/addJob">Add A Job</NavLink>
                        <NavLink className={location.pathname === '/myJobs' && 'text-blue-500'} to="/myJobs">My Jobs</NavLink>
                        <NavLink className={location.pathname === '/blogs' && 'text-blue-500'} to="/blogs">Blogs</NavLink>

...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        ...
        loader: () => fetch('https://job-hunt-nest-server.vercel.app/jobs')
      },
      {
        path: '/appliedJobs',
        element: <Private><AppliedJobs></AppliedJobs></Private>,
        // loader: () => fetch('https://job-hunt-nest-server.vercel.app/applicants'),
      ...
      },
      {
        ...
        loader: ({params}) => fetch(`https://job-hunt-nest-server.vercel.app/jobs/${params.id}`)
      },
      {
        path: '/allDetails/:id',
